...
function getAdminInboxStyles() {
  return `
    .admin-inbox-root { --fb-radius: 12px; --fb-shadow: 0 4px 20px rgba(31, 41, 51, 0.07); }
    .fb-top {
      background: var(--surface);
      border-bottom: 1px solid var(--border);
      box-shadow: var(--fb-shadow);
    }
    .fb-top-inner { max-width: 1200px; margin: 0 auto; padding: 1.1rem 1.25rem 1.25rem; }
    .fb-brand { display: flex; flex-wrap: wrap; align-items: flex-start; justify-content: space-between; gap: 0.75rem; }
    .fb-brand h1 { margin: 0; font-size: 1.25rem; font-weight: 700; color: var(--accent-dark); letter-spacing: -0.02em; }
    .fb-brand-actions { display: flex; align-items: center; gap: 0.5rem; }
    .fb-inline-form { margin: 0; }
    .fb-sub { margin: 0.35rem 0 0; font-size: 0.85rem; color: var(--muted); }
    ...
    .fb-toolbar { max-width: 1200px; margin: 0 auto; padding: 0.75rem 1.25rem 1rem; display: flex; flex-wrap: wrap; align-items: center; gap: 0.5rem; }
    .fb-toolbar span { font-size: 0.85rem; color: var(--muted); margin-right: 0.35rem; }
    .fb-filter {
      border: 1px solid var(--border); background: var(--surface); color: var(--ink); font: inherit; font-weight: 600;
      font-size: 0.88rem; padding: 0.45rem 0.85rem; border-radius: 999px; cursor: pointer;
    }
    ...
    .fb-wrap { max-width: 1200px; margin: 0 auto; padding: 0 1.25rem 2.5rem; }
    .fb-table-wrap { background: var(--surface); border: 1px solid var(--border); border-radius: var(--fb-radius); box-shadow: var(--fb-shadow); overflow: auto; }
    ...
    .fb-btn { font: inherit; font-weight: 600; font-size: 0.85rem; padding: 0.45rem 0.85rem; border-radius: 999px; border: 1px solid var(--border); cursor: pointer; background: var(--surface); color: var(--accent-dark); }
